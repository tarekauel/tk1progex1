...
import controllers.SendButtonActionListener;
import views.components.TagSelect;
...
public class ClientView extends JFrame {
  ...
  public ClientView(Client ctrl) {
    ...
    this.sendMsgBtn.addActionListener(new SendButtonActionListener(this));
  ...
  public TagSelect getMessageTags() {
    return messageTags;
  }
